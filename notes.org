...
alignment errors. Potential errors are multiple: alignment errors, sequences,
assembly errors. and annotation errors.
** Significance
** Approach
...
errors. In the second analysis, they find that segment-filtering methods improve
